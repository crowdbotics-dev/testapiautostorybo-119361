...
## Project Structure
    ...
    ├── testapiautostorybo_119361  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_119361`
...
2. Clone this repo and `cd testapiautostorybo_119361`
